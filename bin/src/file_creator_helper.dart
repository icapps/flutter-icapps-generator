...
class FileCreatorHelper {
  ...
  static void createViewModelFile(String screenName) {
    ...
    // Write to file
    File(join('lib', 'viewmodels', screenName, '${screenName}_viewmodel.dart')).writeAsStringSync(sb.toString());
  }

  static void createScreenFile(String projectName, String screenName) {
    final sb = StringBuffer()
      ..writeln("import 'package:$projectName/viewmodels/$screenName/${screenName}_viewmodel.dart';")
      ..writeln("import 'package:flutter/material.dart';")
    ...
    // Write to file
    File(join('lib', 'screens', screenName, '${screenName}_screen.dart')).writeAsStringSync(sb.toString());
  }
  ...
  static Future<void> updateInjector(String projectName, String screenName) async {
    ...
    final sb = StringBuffer()..writeln("import 'package:$projectName/viewmodels/$screenName/${screenName}_viewmodel.dart';");
  ...
  static Future<void> updateMainNavigator(String projectName, String screenName) async {
    ...
    final sb = StringBuffer()
      ..writeln("import 'package:$projectName/screens/$screenName/${screenName}_screen.dart';")
